            ...
            <ul className="w-full flex flex-col divide-y divide-solid divide-e2 dark:divide-slate-400">
                ...
                <li className={`${toggle === 3 ? "flex" : "hidden"} w-full py-5`}>
                    <form className="flex items-center justify-between w-full gap-5" onSubmit={(e)=>{
                        ...
                        <input type="text" name="promo-code" placeholder="Add Promo code" className="block h-8 pl-2.5 placeholder:text-7c placeholder:text-sm dark:placeholder:text-e2 placeholder:font-medium bg-transparent border-b border-solid border-main dark:border-purple-500 focus:outline-none text-base text-txt-main font-semibold caret-txt-main dark:text-white dark:caret-e2 w-full" />
